...
Also this app allows users to impersonate/log in as existing users to answer existing polls, create new polls, and see other users' scores on the leaderboard.
